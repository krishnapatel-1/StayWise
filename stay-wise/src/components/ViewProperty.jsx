...
if (leg) {
  ...
  return (
    <div className="property-container">
      ...
      <button onClick={() => navigate(`/edit-property/${property._id}`)} style={{ marginLeft: "10px" }}>Edit Details</button>
      ...
      {isCustomer && isLoaded && destination && (
        <div className="map-wrapper">
          ...
          <Autocomplete onLoad={(ref) => setAutocomplete(ref)} onPlaceChanged={() => {
